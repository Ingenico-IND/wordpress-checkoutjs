...
function menupage2(){
	add_menu_page('Page Title2', 'Reconcilation ', 'manage_options', 'reconcilation', 'recon_default', ' dashicons-money-alt ');
}
...
function recon_default(){
	...
	if (isset($_POST["submit"])){
		...
		?>
		<div class="container"><p><mark><?php echo $message; ?></mark></p><span class="border"></span></div>	
		<?php
	}	
